...
Pin a version with `HUBSCOPE_VERSION=v0.2.3`. Overridable via env: `HUBSCOPE_PREFIX`, `HUBSCOPE_DATA_DIR`, `HUBSCOPE_PORT` — see the script header.
...
./hubscope_v0.2.3_linux_amd64 admin create --username admin --password 'your-strong-password'
```
