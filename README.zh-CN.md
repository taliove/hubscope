...
可用 `HUBSCOPE_VERSION=v0.5.1` 锁定版本;`HUBSCOPE_PREFIX`、`HUBSCOPE_DATA_DIR`、`HUBSCOPE_PORT` 等环境变量可覆盖默认值,详见脚本头部注释。
...
./hubscope_v0.5.1_linux_amd64 admin create --username admin --password '换成强口令'
```
